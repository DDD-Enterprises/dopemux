...
class TestCLIIntegration:
    ...
    def test_autoresponder_setup_command(self, runner, temp_project):
        ...
        with runner.isolated_filesystem():
            ...
            with patch('integrations.claude_autoresponder.ClaudeAutoResponderManager.setup_autoresponder') as mock_setup:
    ...
    def test_autoresponder_start_command(self, runner, temp_project):
        ...
        with runner.isolated_filesystem():
            ...
            with patch('integrations.claude_autoresponder.ClaudeAutoResponderManager.start') as mock_start:
    ...
    def test_autoresponder_stop_command(self, runner, temp_project):
        ...
        with runner.isolated_filesystem():
            ...
            with patch('integrations.claude_autoresponder.ClaudeAutoResponderManager.is_running') as mock_running, \
                 patch('integrations.claude_autoresponder.ClaudeAutoResponderManager.stop') as mock_stop, \
                 patch('integrations.claude_autoresponder.ClaudeAutoResponderManager.get_status') as mock_status:
    ...
    def test_autoresponder_status_command(self, runner, temp_project):
        ...
        with runner.isolated_filesystem():
            ...
            with patch('integrations.claude_autoresponder.ClaudeAutoResponderManager.get_status') as mock_status:
                mock_status.return_value = {
                    'status': 'running',
                    'running': True,
                    'uptime_minutes': 30.0,
