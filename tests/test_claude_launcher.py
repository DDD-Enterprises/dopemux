...
class TestClaudeLauncher:
    ...
    def test_launch_interactive(self, mock_mkstemp, mock_popen, config_manager, temp_project_dir):
    ...
    @patch('subprocess.Popen')
    @patch('tempfile.mkstemp')
    def test_launch_background(self, mock_mkstemp, mock_popen, config_manager, temp_project_dir):
    ...
    @patch('subprocess.Popen')
    @patch('tempfile.mkstemp')
    def test_launch_with_debug(self, mock_mkstemp, mock_popen, config_manager, temp_project_dir):
    ...
    def test_generate_claude_config_with_context(self, config_manager, temp_project_dir):
    ...
    def test_mcp_server_configuration_generation(self, config_manager, temp_project_dir):
