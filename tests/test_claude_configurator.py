...
class TestClaudeConfigurator:
    ...
    def test_update_project_config(self, config_manager, temp_project_dir):
        ...
        updates = {
            'adhd_profile.focus_duration': 30,
    ...
    def test_setup_project_config_creates_all_template_content(self, config_manager, temp_project_dir):
    ...
    def test_file_content_integration(self, config_manager, temp_project_dir):
        ...
        for filename, content in files.items():
            ...
            assert js_found, f"{filename} should contain JavaScript-specific content. Content preview: {content[:200]}..."